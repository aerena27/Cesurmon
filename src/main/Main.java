...
public class Main {
    ...
    Pokemon p1 = new Pokemon(01, "Malenia", "", 1000, 80, 20, 40, 10, 30, 10, 0, 0, Estado.SIN_ESTADO, Tipo.DENDRO);
    Pokemon p2 = new Pokemon(02, "Radhan", "", 1000, 50, 30, 80, 40, 10, 10, 0, 0, Estado.SIN_ESTADO, Tipo.ELECTRO);
