...
public class Combate extends JFrame {
	...
	public Combate() {		
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(Combate.class.getResource("/recursos/EvUOT3_UUAIw-aA.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(Combate.class.getResource("/recursos/b786c23aad9430eed946f3f85036bab9.jpg")));
